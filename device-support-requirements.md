...
* All devices with hardware encoding/decoding support in their stock OS MUST support hardware encoding/decoding for all codecs supported by their stock OS.
