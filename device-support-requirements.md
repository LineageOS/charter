...
| 2018/02/11 | Android TV devices | In-Remote Microphones          | Requires propritary audio routing/methods that have no OSS counterpart, and rely on proprietary functions. MUST not use a prebuilt Audio HAL to workaround this, MUST support Microphone input through the Android TV Remote app.|
---
