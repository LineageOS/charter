...
* Maintainers MUST verify official Lineage Recovery distributions work for LineageOS installation.
* Maintainers MUST ship Lineage Recovery as the default solution for their device on the Wiki.
