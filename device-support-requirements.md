...
| 2023/04/11 | FDE devices | Encryption | As of Android 13, FDE is no longer supported. Some devices have custom keymaster HAL implementations that only allow FDE to function. Device's only capable of using FDE that are promoted to LineageOS 20 or above are exempted from encryption requirements. |
---
