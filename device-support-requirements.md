...
| 2026/04/16 | Non-Android Game Consoles | Clock manipulation | Game consoles which lack an Android-based stock OS are permitted to utilize a custom bootloader to configure kernel clocks. | 
