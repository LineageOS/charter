...
| 2023/04/11 | LGE legacy-UM      | Encryption                     | These devices cannot support encryption due to LG's custom Keymaster implementation/firmware which is incompatible with FDE, which is removed in Android 13. These devices are exempted from the encryption requirements. |
---
