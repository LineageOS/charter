...
| 2026/04/16 | nx*                | Clock manipulation             | This device lacks an Android-based stock OS, and has different clockings depending on dock-status. This device is permitted to ship a custom bootloader which can configure kernel clocks. | 
