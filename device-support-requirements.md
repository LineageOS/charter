...
* All devices with a Fingerprint Sensor MUST support the Fingerprint Sensor if the stock OS supports it with Marshmallow or higher
* All devices with a Fingerprint Sensor SHOULD support the Fingerprint Sensor 
...
* Battery
* No abnormal power drains
* CPU Profiling
* No overclocks by default
...
|------------|------------|--------------------------------|--------|
| 2018/02/08 | Samsung    | Hardware Encryption            | Samsung devices that cannot support hardware encryption due to Knox/Tee are exempted from the hardware crypto requirements. MUST still support software cyrpto.|
