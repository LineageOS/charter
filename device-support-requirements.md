...
* All USB-C devices MUST support all the power profiles supported on their stock OS.
* All USB-C devices MUST support all the video profiles supported on theit stock OS.
